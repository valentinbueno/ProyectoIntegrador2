...
insert into comentarios(id_producto, id_creador, comentario, created_at, updated_at ) values(1, 1,'toda mi vida use las tablets de Samsung, pero despues de probar esta, se que Ipad es mejor', default, default );
